...
@Component({
  ...
  templateUrl: './poll-details-03.component.html',
})
export class PollDetailsComponent03 implements OnInit {

  pollTitle = "examplepoll03";
  party = "this"
  ...
  constructor(
    ...
    // this.getAssetParty01 = 10;
    // this.pieChartData[1] = this.getAssetParty01;
